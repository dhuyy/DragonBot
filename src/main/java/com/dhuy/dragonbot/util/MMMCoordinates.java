...
public class MMMCoordinates {
  private static MMMCoordinates instance = new MMMCoordinates();
  ...
  public static final int CHECK_EXISTING_OFFER_BUY_OFFERS_Y = 512; // +17
  ...
  private MMMCoordinates() {}

  public static MMMCoordinates getInstance() {
    if (instance == null) {
      synchronized (MMMCoordinates.class) {
        if (instance == null) {
          instance = new MMMCoordinates();
        }
      }
    }
